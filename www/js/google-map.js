$(document).ready(function() {
    ...
    if ($('#map-object').length !== 0) {
        var mapCenter = new google.maps.LatLng(21.2306923, 81.6503131);
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                Map_data = JSON.parse(xhttp.responseText);
                showmap(Map_data);
             }
        }
        xhttp.open("GET", "https://rajatbuildtech.com/data/list.php", true);
        xhttp.send();
